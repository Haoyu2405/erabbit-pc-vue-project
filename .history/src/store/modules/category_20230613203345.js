...
export default {
  ...
  actions: {
    /**
     * By using { commit } as the function parameter, it allows you to access the commit method directly within the function without explicitly referencing context.commit.
