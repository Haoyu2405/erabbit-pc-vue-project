<template>
  <div class="goods-comment">
    ...
    <div class="sort">
      <span>排序：</span>
      <a :class="{ active: reqParams.tag === null }" href="javascript:;"
        >默认</a
      >
      <a :class="{ active: reqParams.sortField==='createTime'}" href="javascript:;">最新</a>
      <a :class="{ active: reqParams.sortField==='createTime'}" href="javascript:;">最热</a>
    </div>
    <!-- 列表 -->
    <div class="list">
      <div class="item">
