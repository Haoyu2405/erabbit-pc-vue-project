<template>
  <div class="sub-sort">
    ...
    <div class="check">
      <XtxCheckbox @change="change" v-model="sortParams.inventory">仅显示有货商品</XtxCheckbox>
      <XtxCheckbox @change="change" v-model="sortParams.onlyDiscount"
        >仅显示特惠商品</XtxCheckbox
      >
    </div>
  </div>
...
export default {
  ...
  setup () {
    ...
    const sortParams = reactive({
      inventory: false,
      onlyDiscount: false,
      // publishTime orderNum evaluateNum price
      sortField: null,
